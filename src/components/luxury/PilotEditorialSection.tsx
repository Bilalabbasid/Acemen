      ...
      <div className="container-page relative z-10">
        <div className="max-w-2xl space-y-6">
          ...
          <p className="font-body text-sm sm:text-base text-neutral-300 font-light leading-relaxed">
            &ldquo;Precision-crafted leather footwear for those who travel with purpose.&rdquo;
          </p>

          <p className="text-xs sm:text-sm text-neutral-400 font-light leading-relaxed">
            Sculpted from mirror-shine full-grain black calfskin. Engineered with non-metallic composite shanks for seamless airport security clearance, anti-static soles, and orthotic arch support designed for long-haul flight endurance.
          </p>
          ...
          <div className="grid grid-cols-2 gap-4 pt-2 text-xs text-neutral-300 font-light">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>Flight Deck Traction Sole</span>
            </div>
            <div className="flex items-center gap-2">
          ...
          <div className="pt-4">
            <Link href="/collections/pilot" className="btn-luxury-white">
